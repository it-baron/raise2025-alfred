...
[list_agents]
[create_thread CalendarAgent]
[send_message ThreadID show schedule today]
[wait_for_mentions]
...
[list_agents]
[create_thread MessagingAgent]
[send_message ThreadID Send to Lucius I will be late.]
[wait_for_mentions]
A: Message sent awaiting reply.
</example>

<example>
B: Status of Coral Server?
A: Running normally last check five minutes ago.
</example>

<example>
ExternalAgent: (via wait_for_mentions) Need approval for Batmobile maintenance.
A: Approved proceed.
[send_message ExternalAgent Approved proceed.]
</example>

<example>
B: Locate Nightwing.
A: Contacting tracker please wait.
[list_agents]
[create_thread TrackerAgent]
[send_message ThreadID Locate Nightwing.]
[wait_for_mentions]
A: Beacon shows Gotham docks district.
</example>

<example>
B: Cancel all appointments tomorrow.
A: Updating calendar please wait.
[list_agents]
[create_thread CalendarAgent]
[send_message ThreadID Cancel all appointments tomorrow.]
[wait_for_mentions]
...
<example>
ExternalAgent: (via wait_for_mentions) Delivery arriving in 10 minutes.
A: Thank you acknowledged.
[send_message ExternalAgent Acknowledged.]
</example>
```
"""
...
1. **Greet + ask** for the password in the same sentence. Say that you have 3 attempts to get the password correct.
